...
| 4 | `ctrend-v1` | CTREND-inspired cross-sectional aggregate technical-trend ensemble | **Frozen before shared 2022-only universe formation and before any Trial 4 2023+ data/performance** | **No development or final performance observed** | Uses exactly Trial 3's immutable 30-member historical universe; 28 frozen price/volume technical signals; weekly rank transforms; 52-week rolling first-stage forecasts; elastic net (`alpha=0.5`, AICc lambda) only selects positively weighted forecasts; equal-average ensemble; top three long-only at 15% each; 45% cap; same 140 bps hurdle. Development is hard-stopped before the untouched 2026 final holdout. |
