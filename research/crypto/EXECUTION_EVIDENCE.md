# MoneyMog crypto execution evidence review — 2026-08-12

This note motivates execution experiment `coinbase-maker-execution-v1`. It is **not** evidence that post-only orders improve MoneyMog returns. E1 must measure fill probability and adverse selection forward before any execution policy is proposed.
...
## Frozen inference for MoneyMog

The correct first question is not “how much would returns improve if fees were 40 bps?” It is:

> **At MoneyMog-sized orders, how often can a post-only order at the touch actually fill within five minutes, and what is its effective cost after queue waiting and post-fill adverse selection compared with immediate taking?**
